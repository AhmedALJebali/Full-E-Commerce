      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="w-full md:w-1/2">
              ...
              <input
                ...
                className="w-full border border-neutral-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-black focus:outline-none"
        ...
        <div className="space-y-6">
          <div className="space-y-4 bg-white p-4 rounded-2xl shadow-sm">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-wrap gap-2">
                {cart.map((item, index) => (
                  <div
                    key={index}
                    className="bg-neutral-100 rounded-full p-1"
                  >
                    <Image
                      src={item.image}
                      alt={item.title}
            ...
            <button className="w-full rounded-xl bg-neutral-900 px-5 py-2.5 text-sm font-medium text-white hover:bg-neutral-800">
              Proceed to Checkout
            </button>
          </div>
        </div>
